...
public class GamejoltManager : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Manager.instance.score > 99 && !points1) { Core.instance.UnlockAchivement(232898); points1 = true; }
        if (Manager.instance.score > 999 && !points2) { Core.instance.UnlockAchivement(232899); points2 = true; }
        if (Manager.instance.score > 9999 && !points3) { Core.instance.UnlockAchivement(232900); points3 = true; }
        if (Manager.instance.score > 99999 && !points4) { Core.instance.UnlockAchivement(232901); points4 = true; }
    }
